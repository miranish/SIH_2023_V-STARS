    ...
    <div className="index">
      ...
      <div class="scrolling-wrapper-flexbox">
        {
          imagesData.map((card, index) => (
            <EcommerceCard key={index} imgIndex={index} title={card.title}  ImgSrc={card.imgSrc}/>
            ))
        }
      </div>
      ...
      <div className="dress-showcase-section">
        <div className="rectangle-showcase">
          <div className="rectangle-showcase-1">
          </div>
              <img className="largeImages largeImages1" src={largeImage1} alt="LargeImage1" />
        </div>

        <div className="rectangle-showcase">
          <div className="rectangle-showcase-2">
          </div>
              <img className="largeImages largeImages2" src={largeImage2} alt="LargeImage2" />
        </div>
      </div>
    </div>
  );
