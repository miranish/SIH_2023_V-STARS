    ...
    <div>
        ...
        <p id="para">
          ...
          <div className="grid-image-showcase">
            ...
            <p data-aos="fade-left">
              ...
              Explore the distinct cultures, languages, and traditions of North
              India, South India, East India, West India, and the central
              heartland. Learn about the uniqueness of each region, from the
              robust Rajput heritage of Rajasthan to the lush backwaters of
              Kerala.
            </p>
          </div>
          <br />
          ...
          <div className="grid-image-showcase">
            <p data-aos="fade-right">
              ...
              Discover the dynasties that have left an indelible mark on India's
              history. From the Mauryas and Guptas to the Mughals and Marathas,
              we'll provide insights into their reigns, architectural marvels,
      ...
      <div class="sec">
        ...
        <p id="para">
          <div className="grid-image-showcase">
            ...
            <img src="https://i3.wp.com/www.thetalentedindian.com/wp-content/uploads/2023/04/Screenshot-2023-04-16-at-9.53.57-AM.png" width={"80%"} data-aos="fade-left" />
          </div>
          <br />
          <br />
          <div className="grid-image-showcase">
          <img src="https://i0.wp.com/d1v9pyzt136u2g.cloudfront.net/blog/wp-content/uploads/2021/12/09110423/taj6-2.jpg?resize=701%2C436&ssl=1" width={"80%"} data-aos="fade-right" />
            <p data-aos="fade-left">
              <i className="para-italic">The Mughal Era:</i> Immerse yourself in
              the opulence of the Mughal dynasty. Discover the iconic Taj Mahal,
              the grandeur of Red Fort, and the synthesis of Indian and Persian
          ...
          <div className="grid-image-showcase">
            <p data-aos="fade-left">
              <i className="para-italic">Independence Struggle:</i> Learn about
              India's arduous journey to independence from British colonial
              rule. Explore the life and teachings of Mahatma Gandhi and other
              prominent freedom fighters.
            </p>
            <img src="https://scholarblogs.emory.edu/postcolonialstudies/files/2014/06/Marche_sel.jpg" width={"80%"} data-aos="fade-left" />
          </div>
        </p>
      </div>
      ...
      <div class="sec">
        ...
        <p id="para">
          <div className="grid-image-showcase">
            <p data-aos="fade-right">
              <i className="para-italic">Temples of Khajuraho:</i> Marvel at the
              intricate erotic carvings of Khajuraho, a UNESCO World Heritage
              site. Discover the symbolism behind these stunning sculptures.
            </p>
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Khajuraho-Lakshmana_temple.JPG/640px-Khajuraho-Lakshmana_temple.JPG" width={"80%"} data-aos="fade-left" />
          </div>
          <br />
          <br />
          <div className="grid-image-showcase">
            <img src="https://blog-content.ixigo.com/wp-content/uploads/2013/08/800px-AJANTA_CAVES_-_C.SHELARE_4.jpg" width={"80%"} data-aos="fade-right" />
            <p data-aos="fade-left">
          ...
          <div className="grid-image-showcase">
            <p data-aos="fade-right">
              <i className="para-italic">Forts and Palaces:</i> India boasts an
              array of magnificent forts and palaces, from the Amber Fort in
              Jaipur to the Mysore Palace. Learn about their architecture,
              history, and the stories they hold.
            </p>
            <img src="https://vagatrip.com/storage/blogs/April2023/1.%20Amber%20Fort,%20Jaipur,%20Rajasthan.jpg" width={"80%"} data-aos="fade-left" />
          </div>
        </p>
      </div>
      ...
      <div class="sec">
        ...
        <p id="para">
          <div className="grid-image-showcase">
            <p data-aos="fade-right">
              <i className="para-italic">The Spice Route:</i> India is the land
              of spices, and its cuisine is a reflection of this richness. We'll
              take you on a journey through the spices, flavors, and regional
              dishes that make Indian cuisine famous worldwide.
            </p>
            <img
          ...
          <div className="grid-image-showcase">
            ...
            <p data-aos="fade-left">
              ...
              Explore the vibrant street food culture in India. From spicy chaat
              in Delhi to mouthwatering vada pav in Mumbai, you'll discover a
              world of flavors on the streets.
            </p>
          </div>
        </p>
      </div>
